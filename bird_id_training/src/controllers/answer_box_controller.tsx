...
export async function ImageAndTextData(birdNames?: string[] | [] | null | undefined) {
    ...
    const defaultNames: string[] = [
        ...
        'TURKEY VULTURE', 'KILLDEAR', 'NORTHERN FLICKER', 'BARN SWALLOW', 'NORTHERN PARULA', 'MALLARD DUCK', 'BLUE HERON', 'SAYS PHOEBE', 'TREE SWALLOW', 'CHIPPING SPARROW', 'SCARLET TANAGER', 'GOLDEN CROWNED KINGLET',
